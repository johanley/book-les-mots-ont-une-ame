/* BookLexerTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. BookLexerTokenManager.java */
package book.lexer;
import java.io.*;

/** Token Manager. */
@SuppressWarnings ("unused")
public class BookLexerTokenManager implements BookLexerConstants {
...
static final int[] jjnextStates = {
   24, 25, 27, 28, 30, 1, 2, 6, 7, 9, 10, 20, 22, 
};
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public BookLexerTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public BookLexerTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
