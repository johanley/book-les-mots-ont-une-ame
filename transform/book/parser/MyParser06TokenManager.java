/* MyParser06TokenManager.java */
/* Generated By:JavaCC: Do not edit this line. MyParser06TokenManager.java */
package book.parser;
import java.io.*;

/** Token Manager. */
@SuppressWarnings ("unused")
public class MyParser06TokenManager implements MyParser06Constants {
...
static private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public MyParser06TokenManager(CharStream stream){
  ...
  /** Constructor. */
  public MyParser06TokenManager (CharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
